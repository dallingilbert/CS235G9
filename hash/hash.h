 ...
 *    constainers such as the hash and map
 *    which we will build later this semester.
 *
 *    This will contain the class definition of:
 *       hashue             : similar to std::hash
 * Author
 *    Br. Helfrich
 ************************************************************************/
#ifndef HASH_H
...
namespace custom
{
    ...
    class Hash
    {
        ...
        /************************************************
        * HASH SIZE
        * Return the number of elements in a specified 
        * hash
        ***********************************************/
        template <class T>
        int Hash<T>::size()
        ...
        /************************************************
        * HASH CAPACITY
        * Return the number of buckets in a specified 
        * hash
        ***********************************************/
        template <class T>
        int Hash<T>::capacity()
        ...
        /************************************************
        * HASH EMPTY
        * Return true or false depending on the state of 
        * our hash table
        ***********************************************/
        template <class T>
        bool Hash<T>::empty()
        ...
        /************************************************
        * HASH FIND
        * Finds a value within our hash table and returns
        ...
        ***********************************************/
        ...
        /************************************************
        * HASH INSERT
        * Inserts a value within our hash table
        ***********************************************/
        template <class T>
        ...
        template <class T>
        virtual Hash<T>::hash(const T& t) = 0
        {
